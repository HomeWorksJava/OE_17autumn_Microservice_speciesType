...
public class ContainerH<Hero> {
    ...
    public ContainerH(int pageitemnumber, int startitemnumber, int fullitemnumber) {
     ...
     */
    public void setItems(List<Hero> items) {
        this.items = items;
    }
    
    public void newElem(Hero s)
    {
        this.items.add(s);
    }
